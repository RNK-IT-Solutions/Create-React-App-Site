    ...
    <div className="sub1">
      ...
      <div className="sub1-back">
        <div className="sub1-content">
          HOME <BsArrowRight /> PRODUCT <BsArrowRight /> MUNG DAL
        </div>
      ...
      <div className="sub1-carousel-container">
        <Slider {...settings}>
          {product
            ?.filter((ca) => {
              if (area === "High") {
                return ca.product_id === 2 && ca.product_qty_type === "High";
              } else if (area === "Standard") {
                return (
                  ca.product_id === 2 && ca.product_qty_type === "Standard"
                );
              } else {
                return (
                  ca.product_id === 2 && ca.product_qty_type === "Standard"
